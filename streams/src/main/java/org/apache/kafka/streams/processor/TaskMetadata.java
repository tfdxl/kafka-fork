...
public class TaskMetadata {
    ...
    public static void main(String[] args) {
        final Set<TopicPartition> set = new HashSet<>();
        final TopicPartition topicPartition = new TopicPartition("topic", 1);
        set.add(topicPartition);
        final TaskMetadata taskMetadata = new TaskMetadata("taskId", set);
        System.err.println(taskMetadata);
        System.err.println(taskMetadata.topicPartitions());
    }
}
